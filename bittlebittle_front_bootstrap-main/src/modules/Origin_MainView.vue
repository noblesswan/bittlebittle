...
<!-- NEW -->
      ...
      <div class="col-lg-4 col-md-6 col-12" v-for="newbottle in newBottles" :key="newbottle.bottleNo">
        <div class="menu-thumb">
          <div class="menu-image-wrap">
            <img src="@/assets/images/breakfast/brett-jordan-8xt8-HIFqc8-unsplash.jpg" class="img-fluid menu-image" alt="">

            <span class="menu-tag bg-warning">New</span>
          </div>

          <div class="menu-info d-flex flex-wrap align-items-center">
            <h4 class="mb-0">{{ newbottle.bottleName }}</h4>
            <button @click="favorite(newbottle)">Like</button>
            <!-- <span class="price-tag bg-white shadow-lg ms-4"></span> -->
...
<!--  -->
      ...
      <div class="col-lg-4 col-md-6 col-12" v-for="bestBottle in bestBottles" :key="bestBottle.bottleNo">
        <div class="menu-thumb">
          <div class="menu-image-wrap">
            <img src="@/assets/images/dinner/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg" class="img-fluid menu-image" alt="">

            <span class="menu-tag bg-info">Best</span>
          </div>

          <div class="menu-info d-flex flex-wrap align-items-center">
            <h4 class="mb-0">{{ bestBottle.bottleName }}</h4>
    ...
    <!-- 찜하기 관련 -->
      <div class="col-12">
        <h2 class="text-center mb-lg-5 mb-4">찜하기 관련</h2>
      </div>
      <div class="col-lg-4 col-md-6 col-12" v-for="relatedFavorites in relatedFavorite" :key="relatedFavorites.bottleNo">
        <div class="menu-thumb">
          <div class="menu-image-wrap">
            <img src="@/assets/images/dinner/farhad-ibrahimzade-ZipYER3NLhY-unsplash.jpg" class="img-fluid menu-image" alt="">

            <span class="menu-tag bg-success">relatedFavorite</span>
          </div>

          <div class="menu-info d-flex flex-wrap align-items-center">
            <h4 class="mb-0">{{ relatedFavorites.bottleName }}</h4>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-12">
        <div class="news-thumb mb-4">
          <a href="news-detail.html">
            <img src="@/assets/images/news/pablo-merchan-montes-Orz90t6o0e4-unsplash.jpg" class="img-fluid news-image" alt="">
          </a>
      ...
      <div class="col-lg-6 col-md-6 col-12">
        <div class="news-thumb mb-4">
          <a href="news-detail.html">
            <img src="@/assets/images/news/stefan-johnson-xIFbDeGcy44-unsplash.jpg" class="img-fluid news-image" alt="">
          </a>
      ...
      <div class="col-lg-4 col-md-4 col-12">
        <div class="news-thumb mb-lg-0 mb-lg-4 mb-0">
          <a href="news-detail.html">
            <img src="@/assets/images/news/gilles-lambert-S_LhjpfIdm4-unsplash.jpg" class="img-fluid news-image" alt="">
          </a>
    ...
    onMounted(()=>{
      ...
      axios.get('/api/bottles')
        .then(res => {
          ...
          bestBottles.value = res.data.bestBottle
          console.log('best data', res.data.bestBottle)

          relatedFavorite.value = res.data.relatedFavorite
          console.log('relatedeFavorite', res.data.relatedFavorite)
