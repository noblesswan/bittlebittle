  ...
  <swiper-slide v-for="newbottle in newBottles" :key="newbottle.bottleNo">
    <div class="slide-container" style="display : flex">
      <div class="slide-image">
        <img :src="getBottleImage(newbottle.bottle1.imgUrl, newbottle.bottle1.imgCusUrl)" alt="보틀 이미지" width="200" height="200">
      </div>
      <div class="slide-title">
        <h4>{{ newbottle.bottleName }}</h4>
      </div>
            <div class="slide-image">
        <img :src="getBottleImage(newbottle.bottle2.imgUrl, newbottle.bottle2.imgCusUrl)" alt="보틀 이미지" width="200" height="200">
      </div>
      <div class="slide-title">
        <h4>{{ newbottle.bottleName }}</h4>
      </div>
            <div class="slide-image">
        <img :src="getBottleImage(newbottle.bottle3.imgUrl, newbottle.bottle3.imgCusUrl)" alt="보틀 이미지" width="200" height="200">
      </div>
      <div class="slide-title">
        <h4>{{ newbottle.bottleName }}</h4>
      </div>
...
export default {
  ...
  setup() {
    const user = useUserStore()
    const userNo = user.getLoginUserInfo.userNo
    const axios = getFormAxiosInstance(user.getLoginUserInfo)
    const newBottles = ref([])
